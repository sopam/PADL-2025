...
% Measure
	...
	#show measure/13.
	measure(Z1,Z2,Z3,Z4,Z5,Z6,W1,W2,W3,W4,W5,W6,X):- f_domain(control,Z1), f_domain(control_N,Z2),
	
	f_domain(control_N,Z3), f_domain(control,Z4),f_domain(control,Z5),
	f_domain(control_N,Z6), Q2 #= Z2*Z2, Q3 #= Z3*Z3,Q6 #= Z6*Z6,
		X #= (W1*Z1)+(W2*Q2)+(W3*Q3)+(W4*Z4)+(W5*Z5)+(W6*Q6).
...
refined(original(A,B,C,D,E,F),id(Z1,Z2,Z3,Z4,Z5,Z6),counterfactual(A1,B1,C1,D1,E1,F1),weights(W1,W2,W3,W4,W5,W6),X):-
	less_equal_50K(A,B,C),
	...
	id_restrict(original(A,B,C,D,E,F),id(Z1,Z2,Z3,Z4,Z5,Z6),counterfactual(A1,B1,C1,D1,E1,F1)), 
	measure(Z1,Z2,Z3,Z4,Z5,Z6,W1,W2,W3,W4,W5,W6,X).
...
?-refined(original(married_civ_spouse,777,4,husband,male,30),id(Z1,Z2,Z3,Z4,0,Z6),counterfactual(A1,B1,C1,D1,E1,F1),weights(2,1,1,1,1,1),X).
